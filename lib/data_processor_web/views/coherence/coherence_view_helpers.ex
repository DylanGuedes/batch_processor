defmodule DataProcessorWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers DataProcessorWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DataProcessorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DataProcessorWeb.Gettext, "errors", msg, opts)
    end
  end
